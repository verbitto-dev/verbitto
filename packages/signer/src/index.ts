...
import { validateTransaction, ALLOWED_PROGRAM_ID } from './security.js'
    ...
    try {
        ...
        if (!buildRes.ok) {
            ...
            res
                ...
                .json({ error: error.error || 'Failed to build transaction' })
            return
        }
        ...
        if (!sendRes.ok) {
            ...
            res
                ...
                .json({ error: error.error || 'Failed to send transaction' })
            return
        }
