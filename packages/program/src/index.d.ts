...
export declare const TASK_STATUS: readonly ["Open", "Claimed", "Submitted", "Approved", "Rejected", "Cancelled", "Expired", "Disputed"];
export type TaskStatus = (typeof TASK_STATUS)[number];
export declare const STATUS_VARIANTS: Record<TaskStatus, 'outline' | 'secondary' | 'default' | 'destructive'>;
