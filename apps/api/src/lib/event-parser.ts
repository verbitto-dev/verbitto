...
function eventDiscriminator(name: string): Buffer {
  return Buffer.from(createHash('sha256').update(`event:${name}`).digest().subarray(0, 8))
}
...
function readHash32(buf: Buffer, offset: number): [string, number] {
  return [Buffer.from(buf.subarray(offset, offset + 32)).toString('hex'), offset + 32]
}

const EVENT_DECODERS: Record<string, EventDecoder> = {
  PlatformInitialized: (buf) => {
    let o = 0
    const [authority, o1] = readPubkey(buf, o)
    o = o1
    const [fee_bps, o2] = readU16(buf, o)
    o = o2
    const [treasury, o3] = readPubkey(buf, o)
    o = o3
  ...
  TaskCreated: (buf) => {
    let o = 0
    const [task, o1] = readPubkey(buf, o)
    o = o1
    const [creator, o2] = readPubkey(buf, o)
    o = o2
    const [task_index, o3] = readU64(buf, o)
    o = o3
    const [bounty_lamports, o4] = readU64(buf, o)
    o = o4
    const [deadline, o5] = readI64(buf, o)
    o = o5
  ...
  TaskClaimed: (buf) => {
    ...
    const [task, o1] = readPubkey(buf, o)
    o = o1
    const [agent, o2] = readPubkey(buf, o)
    o = o2
    const [task_index, o3] = readU64(buf, o)
    o = o3
  ...
  DeliverableSubmitted: (buf) => {
    ...
    const [agent, o2] = readPubkey(buf, o)
    o = o2
    const [deliverable_hash, o3] = readHash32(buf, o)
    o = o3
  ...
  TaskSettled: (buf) => {
    ...
    const [agent, o2] = readPubkey(buf, o)
    o = o2
    const [payout_lamports, o3] = readU64(buf, o)
    o = o3
    const [fee_lamports, o4] = readU64(buf, o)
    o = o4
  ...
  SubmissionRejected: (buf) => {
    ...
    const [agent, o2] = readPubkey(buf, o)
    o = o2
    const [reason_hash, o3] = readHash32(buf, o)
    o = o3
  ...
  TaskCancelled: (buf) => {
    ...
    const [creator, o2] = readPubkey(buf, o)
    o = o2
    const [refunded_lamports, o3] = readU64(buf, o)
    o = o3
  ...
  TemplateCreated: (buf) => {
    let o = 0
    const [template, o1] = readPubkey(buf, o)
    o = o1
    const [creator, o2] = readPubkey(buf, o)
    o = o2
    const [template_index, o3] = readU64(buf, o)
    o = o3
    const [category, o4] = readU8(buf, o)
    o = o4
  ...
  DisputeOpened: (buf) => {
    let o = 0
    const [dispute, o1] = readPubkey(buf, o)
    o = o1
    const [task, o2] = readPubkey(buf, o)
    o = o2
    const [initiator, o3] = readPubkey(buf, o)
    o = o3
    const [reason, o4] = readU8(buf, o)
    o = o4
  ...
  VoteCast: (buf) => {
    ...
    const [dispute, o1] = readPubkey(buf, o)
    o = o1
    const [voter, o2] = readPubkey(buf, o)
    o = o2
    const [ruling, o3] = readU8(buf, o)
    o = o3
  ...
  DisputeResolved: (buf) => {
    ...
    const [ruling, o3] = readU8(buf, o)
    o = o3
    const [total_votes, o4] = readU16(buf, o)
    o = o4
  ...
  AgentRegistered: (buf) => {
    let o = 0
    const [agent, o1] = readPubkey(buf, o)
    o = o1
    const [profile, o2] = readPubkey(buf, o)
    o = o2
  ...
  AgentProfileUpdated: (buf) => {
    ...
    const [agent, o1] = readPubkey(buf, o)
    o = o1
    const [reputation_score, o2] = readI64(buf, o)
    o = o2
    const [tasks_completed, o3] = readU64(buf, o)
    o = o3
...
export function parseEventsFromLogs(
  ...
  for (const line of logMessages) {
    ...
    if (
      line.startsWith(`Program ${PROGRAM_ID} success`) ||
...
function parseOneTransaction(tx: unknown): IndexedEvent[] {
  ...
  if (obj.signature && typeof obj.signature === 'string') {
    ...
    const logMessages = enhanced.transaction?.meta?.logMessages ?? []
 ...
 */
export function extractTitlesFromTx(tx: {
  transaction: {
    message: {
  ...
  const accountKeys = (msg.staticAccountKeys ?? msg.accountKeys ?? []) as Array<{
    toBase58(): string
  }>
