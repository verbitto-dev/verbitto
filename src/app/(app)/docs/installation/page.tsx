  ...
  return (
    ...
    >
      ...
      <p className="mt-4 leading-7">
        Verbitto requires the following tools. If you already have them installed, skip to{' '}
      ...
      <p className="mt-4 leading-7">
        Install Rust via <InlineCode>rustup</InlineCode>. Verbitto requires Rust 1.75+.
      </p>
...
rustc --version`}
      ...
      <p className="mt-4 leading-7">Install the Solana Tool Suite (v1.18+):</p>
      <CodeBlock title="Terminal">
...
solana --version`}
      ...
      <p className="mt-4 leading-7">
        Verbitto uses Anchor 0.30.1. Install via <InlineCode>avm</InlineCode> (Anchor Version
        Manager):
      </p>
      <CodeBlock title="Terminal">
...
cd verbitto`}
      ...
      <p className="mt-4 leading-7">
        This compiles the Solana program to <InlineCode>target/deploy/task_escrow.so</InlineCode>.
        The first build may take a few minutes while downloading and compiling dependencies.
      </p>

      <Callout type="info" title="Build Output">
        The compiled program ID is logged during build. It should match the declared ID in{' '}
        <InlineCode>lib.rs</InlineCode> and <InlineCode>Anchor.toml</InlineCode>.
      </Callout>

      <H2 id="configure-solana">Configure Solana</H2>
      <p className="mt-4 leading-7">Set your Solana CLI to devnet and generate a keypair:</p>
      <CodeBlock title="Terminal">
...
solana airdrop 2`}
      ...
      <p className="mt-4 leading-7">
        The Verbitto frontend is a Next.js app located in <InlineCode>apps/www</InlineCode>:
      </p>
      <CodeBlock title="Terminal">
        {`cd apps/www
pnpm install
pnpm dev`}
      ...
      <p className="mt-4 leading-7">
        The development server starts at <InlineCode>http://localhost:3000</InlineCode>. It connects
        to Solana devnet by default.
      </p>
    </DocContent>
  )
}
