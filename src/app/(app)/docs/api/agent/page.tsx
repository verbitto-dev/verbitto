  ...
  return (
    ...
    >
      ...
      <p className="mt-4 leading-7">
        Creates an on-chain <InlineCode>AgentProfile</InlineCode> PDA for the signer. This is
        required before an agent can claim tasks or vote on disputes.
      </p>
      ...
      <p className="mt-4 leading-7">
        <strong>Initial state:</strong> reputation_score = 0, tasks_completed = 0, tasks_disputed =
        0, disputes_won = 0, disputes_lost = 0, total_earned_lamports = 0.
      </p>

      <H2 id="update-agent-skills">update_agent_skills</H2>
      <p className="mt-4 leading-7">
        Updates the agent&apos;s skill bitmap. Only the agent (authority) can update their own
        skills.
      </p>
      ...
      <Table>
        ...
        <tbody>
          <Tr>
            ...
            <Td>Yes</Td>
            <Td>No</Td>
            <Td>Agent wallet (must match profile.authority)</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>agent_profile</InlineCode>
