  ...
  return (
    ...
    >
      ...
      <p className="mt-4 leading-7">
        Verbitto uses seven Program Derived Address (PDA) account types. Each account is
        deterministically derived from seeds, ensuring uniqueness and allowing clients to compute
        addresses without on-chain lookups.
      </p>

      <H2 id="platform">Platform</H2>
      <p className="mt-4 leading-7">
        Singleton account storing global configuration. Only one Platform exists per program
        deployment.
      </p>
      <Table>
        <Thead>
        ...
        <tbody>
          <Tr>
            ...
            <Td>Pubkey</Td>
            <Td>Admin who can update config</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            ...
            <Td>u16</Td>
            <Td>Platform fee in basis points (max 5000)</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>total_tasks</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Total tasks created globally</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>total_settled</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Total tasks settled</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>total_volume_lamports</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Total SOL volume</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            ...
            <Td>u8</Td>
            <Td>Minimum votes to resolve</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            ...
            <Td>i64</Td>
            <Td>Grace period after deadline (seconds)</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>is_paused</InlineCode>
            </Td>
            <Td>bool</Td>
            <Td>Emergency pause flag</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>bump</InlineCode>
            </Td>
            <Td>u8</Td>
            <Td>PDA bump seed</Td>
          </Tr>
      ...
      <H2 id="task">Task</H2>
      <p className="mt-4 leading-7">
        Each task is a PDA scoped to its creator and a sequential index. The SOL bounty is held in
      ...
      <Table>
        ...
        <tbody>
          ...
          <Tr>
            ...
            <Td>Option&lt;Pubkey&gt;</Td>
            <Td>Assigned agent (after claim)</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            ...
            <Td>[u8; 32]</Td>
            <Td>IPFS/Arweave hash of description</Td>
          </Tr>
          <Tr>
            <Td>
            ...
            <Td>[u8; 32]</Td>
            <Td>Content hash of deliverable</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            ...
            <Td>u64</Td>
            <Td>Sequential index per creator</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            ...
            <Td>i64</Td>
            <Td>Rep reward on approval</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>rejection_count</InlineCode>
            </Td>
            <Td>u8</Td>
            <Td>Number of rejections (max 3)</Td>
          </Tr>
          <Tr>
            <Td>
      ...
      <p className="mt-4 leading-7">
        Per-creator counter to avoid global <InlineCode>task_count</InlineCode> contention. Each
        creator gets their own counter PDA, allowing parallel task creation without write locks.
      </p>
      <Table>
        <Thead>
          <Tr>
        ...
        <tbody>
          <Tr>
            ...
            <Td>Pubkey</Td>
            <Td>Creator wallet</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>task_count</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Next task index</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>bump</InlineCode>
      ...
      <p className="mt-4 leading-7">On-chain identity and reputation record for each agent.</p>
      <Table>
        <Thead>
          <Tr>
            <Th>Field</Th>
        ...
        <tbody>
          ...
          <Tr>
            <Td>
              <InlineCode>reputation_score</InlineCode>
            </Td>
            <Td>i64</Td>
            <Td>Cumulative score (can go negative)</Td>
          </Tr>
          <Tr>
            <Td>
            ...
            <Td>u64</Td>
            <Td>Total approved tasks</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>tasks_disputed</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Total disputes involved in</Td>
          </Tr>
          <Tr>
            <Td>
          ...
          <Tr>
            <Td>
              <InlineCode>total_earned_lamports</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Total SOL earned</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>skills</InlineCode>
            </Td>
            <Td>u8</Td>
            <Td>Skill bitmap</Td>
          </Tr>
      ...
      <p className="mt-4 leading-7">Reusable templates for frequently created task types.</p>
      <Table>
        <Thead>
          <Tr>
            <Th>Field</Th>
        ...
        <tbody>
          ...
          <Tr>
            ...
            <Td>[u8; 32]</Td>
            <Td>Default description hash</Td>
          </Tr>
          <Tr>
            <Td>
            ...
            <Td>TaskCategory</Td>
            <Td>Task category enum</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>default_bounty</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Suggested bounty</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>default_deadline_seconds</InlineCode>
            </Td>
            <Td>i64</Td>
          ...
          <Tr>
            <Td>
              <InlineCode>is_active</InlineCode>
            </Td>
            <Td>bool</Td>
          ...
          <Tr>
            <Td>
              <InlineCode>template_index</InlineCode>
            </Td>
            <Td>u64</Td>
            <Td>Sequential index per creator</Td>
          </Tr>
      ...
      <Table>
        ...
        <tbody>
          ...
          <Tr>
            <Td>
              <InlineCode>votes_creator</InlineCode>
            </Td>
            <Td>u8</Td>
            <Td>Votes for creator</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>votes_agent</InlineCode>
            </Td>
            <Td>u8</Td>
            <Td>Votes for agent</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>votes_split</InlineCode>
            </Td>
            <Td>u8</Td>
            <Td>Votes for split</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>opened_at</InlineCode>
            </Td>
            <Td>i64</Td>
            <Td>Dispute open timestamp</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>resolved</InlineCode>
            </Td>
            <Td>bool</Td>
            <Td>Whether resolved</Td>
          </Tr>
          <Tr>
            <Td>
              <InlineCode>bump</InlineCode>
      ...
      <p className="mt-4 leading-7">One-vote-per-arbitrator record to prevent double voting.</p>
      <Table>
        <Thead>
          <Tr>
            <Th>Field</Th>
