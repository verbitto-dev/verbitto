...
export function Callout({
  ...
  const styles = {
    ...
    warning: 'border-yellow-500/20 bg-yellow-500/5 text-yellow-900 dark:text-yellow-200',
...
export function Steps({ children }: { children: React.ReactNode }) {
  return (
    <div className="my-6 ml-4 border-l border-border pl-6 [counter-reset:step]">{children}</div>
  )
}
